...
insert funcionario value ('Fernando','33344555587','08-12-1965','rua da lapa','M', 40000,'8886555576', 5);
...
insert dependente values ('33344555587', 'Alicia', 'F', '05-04-1986', 'filha' );
insert dependente values ('33344555587', 'Tiago', 'M', '25-10-1983', 'filho' );
...
insert dependente values ('12345678966', 'Alicia', 'F', '30-12-1988', 'filha' );
insert dependente values ('12345678966', 'Elizabeth', 'F', '05-05-1967', 'esposa' );


DELIMITER $$
CREATE PROCEDURE aumentarSalario(in vcpf varchar(11))
BEGIN
UPDATE funcionario
...
SELECT * from funcionario;
call aumentarSalario("66688444476");


DELIMITER $$
CREATE PROCEDURE diminuirSalario(in vcpf varchar(11))
BEGIN
UPDATE funcionario
...
SELECT * from funcionario;
call diminuirSalario("66688444476");


DELIMITER $$
CREATE PROCEDURE InclusaoProjeto (in vprojNome varchar(15), in vprojnumero int,
in vprojLocal varchar(15), in vDNum int)
BEGIN
INSERT INTO proeto (projNome, projNumero, projLocal, DNum)
VALUES (vProjNome, vProjNumero, vProjLocal, vDnum);
END $$
DELIMITER ;
